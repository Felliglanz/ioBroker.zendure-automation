...
class MultiDeviceController {
    ...
    async runCycle(config) {
        ...
        await this.multiDeviceMgr.writePowerSetpoints(distribution, aggregatedState, this.validationService);
    ...
    async handleEmergencyDevices(config, emergencyDevices) {
        ...
        for (const device of emergencyDevices) {
            ...
            if (deviceConfig) {
                ...
                await this.validationService.writePowerSetpoint(device.id, deviceConfig.basePath, powerW);
