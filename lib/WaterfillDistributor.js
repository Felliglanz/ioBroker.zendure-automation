...
class WaterfillDistributor {
    constructor(adapter = null) {
        ...
        this.directionState = {
            charge: { mode: 'spread', activeDeviceId: null, previousDeviceId: null, holdCycles: 0, handoverHoldCycles: 0 },
            discharge: { mode: 'spread', activeDeviceId: null, previousDeviceId: null, holdCycles: 0, handoverHoldCycles: 0 }
        };
    }
